                            ...
                            >
                              ...
                              <h6>
                                ...
                                >
                                  ...
                                  take screenshots, and receive key presses. 💻
                                </p>
                              </h6>
                              <div
                            ...
                            >
                              ...
                              <h6>
                                ...
                                >
                                  ...
                                  and send real-time articles to your Discord channel.😀
                                </p>
                              </h6>
                              <div
                                className="project--lang"
                          ...
                          <Fade bottom>
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <img src={library} alt="Library Management System" />
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/mymadhavyadav07/Library-Management-System"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                The Library Management System is a robust 
                                client-server architecture software designed 
                                to efficiently manage library operations. 
                                Its intuitive GUI offers easy navigation for 
                                librarians to catalog books, manage memberships, 
                                track borrowings, and generate reports. With 
                                seamless client-server communication, it ensures 
                                smooth data exchange and enhances library workflow.
                                </p>
                              </h6>
                              <div
                                className="project--lang"
                          ...
                          <Fade bottom>
                            ...
                            >
                              <div className="projectContent">
                                ...
                                <img src={vision} alt="The-Vision" />
                                <div className="project--showcaseBtn">
                                  <a
                                    href={
                                      "https://github.com/mymadhavyadav07/The-Vision"
                                    }
                                    target="_blank"
                                    rel="noreferrer"
                                    className={"iconBtn"}
                              ...
                              <h6>
                                ...
                                >
                                  This is a Telegram bot for using OSINT tools on your fingertips.
                                </p>
                              </h6>
                              <div
                                className="project--lang"
